<template>
    <div>
        ...
        <b-modal ref="data-modal" :title="dataModelTitle" size="xl" hide-footer>
            ...
            <vue-dropzone ref="myVueDropzone" id="dropzone" :options="dropzoneOptions" @vdropzone-success="vdropzoneSuccess" v-bind:headers="headers" ></vue-dropzone>
    ...
    export default {
        ...
        computed: { 
            headers() { 
                ...
                console.log('compute token',this.adminToken, token.content)
                return { 
