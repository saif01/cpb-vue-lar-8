    ...
    <div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-6">
                        <h3 class="card-title">Business Operations Table</h3>
                    </div>
                    <div class="col-6">
        ...
        <b-modal ref="data-modal" :title="dataModelTitle" size="xl" hide-footer>
            <form @submit.prevent="editmode ? updateData() : createData()">
                ...
                <b-form-group label="Business Operation Title:">
                    <b-form-input v-model="form.title" placeholder="Enter Business Operation Title" size="sm"
                ...
                <b-form-group label="Business Operation Details:">
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                //current page url
                currentUrl: '/api/admin/business_operation',
