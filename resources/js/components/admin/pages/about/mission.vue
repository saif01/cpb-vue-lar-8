    ...
    <div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-6">
                        <h3 class="card-title">Mission Table</h3>
                    </div>
                    <div class="col-6">
        ...
        <b-modal ref="data-modal" :title="dataModelTitle" size="lg" hide-footer>
            <form @submit.prevent="editmode ? updateData() : createData()">
                ...
                <b-form-group label="Details:">
                    <b-form-textarea v-model="form.details" placeholder="Enter mission details" rows="3"
                        max-rows="6" :class="{ 'is-invalid': form.errors.has('details') }"></b-form-textarea>
