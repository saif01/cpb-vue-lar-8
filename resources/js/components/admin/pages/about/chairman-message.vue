    ...
    <div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-6">
                        <h3 class="card-title">Chairman Message Table</h3>
                    </div>
                    <div class="col-6">
        ...
        <b-modal ref="data-modal" :title="dataModelTitle" size="xl" hide-footer>
            <form @submit.prevent="editmode ? updateData() : createData()">
                ...
                <b-form-group label="Title:">
                    <b-form-input v-model="form.title" placeholder="Enter message title" size="sm"
                ...
                <b-form-group label="Message Details:">
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                //current page url
                currentUrl: '/api/admin/chairman_message',

                imagePathSm: '/images/chairman/small/',
