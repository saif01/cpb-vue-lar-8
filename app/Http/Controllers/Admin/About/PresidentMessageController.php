...
class PresidentMessageController extends Controller
{
    ...
    public function index(){
        ...
        $allData = AboutPresidentMessage::orderBy($sort_field, $sort_direction)
    ...
    public function store(Request $request){
        ...
        $this->validate($request,[
            'title'     => 'required|string|max:1000|unique:about_president_messages',
            'details'   => 'required|string|max:40000',
        ]);

        $data = new AboutPresidentMessage();

      
        if($request->image){

            $imagePath = 'images/president/';
    ...
    public function update(Request $request, $id){
        ...
        //Validate
        $this->validate($request,[
            'title'     => 'required|string|max:1000|unique:about_president_messages,title,'.$id,
            'details'   => 'required|string|max:40000',
        ]);

        $data = AboutPresidentMessage::find($id);
