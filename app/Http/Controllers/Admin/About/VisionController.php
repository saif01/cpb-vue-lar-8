...
class VisionController extends Controller
{
    ...
    public function index(){
        ...
        $allData = AboutVision::orderBy($sort_field, $sort_direction)
    ...
    public function store(Request $request){
        ...
        $this->validate($request,[
            'title'     => 'required|string|max:1000|unique:about_visions',
    ...
    public function update(Request $request, $id){
        ...
        //Validate
        $this->validate($request,[
            'title'     => 'required|string|max:1000|unique:about_visions,title,'.$id,
            'details'   => 'required|string|max:40000',
        ]);

        $data = AboutVision::find($id);
